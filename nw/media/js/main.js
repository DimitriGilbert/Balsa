var base_url="http://127.0.0.1/Balsa_dev/dev/www/"
function file(url)
{
...
function init_tiny_mce(tiny_element)
{
	tinyMCE.init(
	{
		// General options
		mode : "exact",
		elements : tiny_element,
		theme : "advanced",
		...
		content_css : base_url+"media/css/css.php",
...
//init_tiny_mce("textarea_description")
