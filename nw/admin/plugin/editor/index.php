...
<html>
	<head>
		<link rel="stylesheet" href="http://127.0.0.1/Balsa/www/admin.php?ajax_admin=1&module=editor&action=css" type="text/css" media="all" />
	...
	<body>
		...
		<div id="scipt_js">
			<?php echo inclure_js() ?>
			<script type="text/javascript" src="http://127.0.0.1/Balsa/www/admin.php?ajax_admin=1&module=editor&action=js"></script>
		</div>
	</body>
</html><?php
		break;
